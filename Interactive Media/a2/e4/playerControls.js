...
function muteUnmute() {
  ...
  // // set the element valued of muted to the opposite of what it is (!):
...
fastForwardButton.addEventListener("mouseover", hoverColour);
rewindButton.addEventListener("click", rewind);
rewindButton.addEventListener("mouseover", hoverColour);
...
window.addEventListener("keydown", (e) => {
  ...
  if (e.key === "ArrowRight") {
    videoElement.currentTime += 1;
    fastForwardButton.style.backgroundColor = "#6f6f6f";
    console.log("fast forward");
  }
  else if (e.key === "ArrowLeft") {
    videoElement.currentTime -= 1;
    rewindButton.style.backgroundColor = "#6f6f6f";
    console.log("rewind");
  }
});
...
window.addEventListener("keyup", (e) => {
  e = e || window.event;
  if (e.key === "ArrowRight") {
    fastForwardButton.style.backgroundColor = "#f0f6f0";
  }
  else if (e.key === "ArrowLeft") {
    rewindButton.style.backgroundColor = "#f0f6f0";
  }
})
